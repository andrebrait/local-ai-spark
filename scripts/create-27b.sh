...
IMAGE="${IMAGE:-sha256:3d2392b19f43e80aa05c602cc978b2400715fbb77908de3d2f14bd1ee4ce796c}"
...
exec docker create --name qwen38-27b \
  ...
  --entrypoint vllm \
  -v "$MODEL_HOST:/models/qwen38-27b:ro" \
